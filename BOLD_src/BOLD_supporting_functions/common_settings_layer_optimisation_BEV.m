...
% copyright year : 2017
% Last Updated   : Thu May  3 22:11:55 BST 2018
% Licensed       : MIT License

OperatingMode      = 2;    % LIONSIMBA operating mode (constant power density)
cutoffSOC          = 5;    % Cutoff SOC  [%] If changing SOC limits, remember to change the initial & finishing SOCs for fast charging, if required!
CutoverSOC         = 95;   % Cutover SOC [%]
