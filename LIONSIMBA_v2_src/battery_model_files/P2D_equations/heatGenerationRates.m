function [Qrev, Qrxn, Qohm]=heatGenerationRates(Phis,Phie,jflux,T,cs_star,ce,param,y)
...
[dPhis, dPhie, dCe] = ThermalDerivatives(Phis',Phie',ce',param,y(end));	% y(end) obtains current from a vector containing algebraic states
dPhis = dPhis';
dPhie = dPhie';
dCe = dCe';
